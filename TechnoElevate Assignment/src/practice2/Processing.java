...
public class Processing {
	...
	static List<ContactFile> al =Arrays.asList(new ContactFile("Karthick",9878786756l,"School" ),new ContactFile("sudhan",9878786756l ,"college" ),new ContactFile("manish",987878672l,"college" ),new ContactFile("risiban",987878326l ,"college" ));
